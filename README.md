...
| https://recordrig-site-git-develop.now.sh                                                                | Vercel "PRODUCTION" variables          | `develop`                                               | DEVELOP branch with PRODUCTION variables. Can be used to smoke test before merging to MASTER - however, **test with caution**, as this _does_ affect PRODUCTION data. |
| https://recordrig-site.now.sh                                                                            | Vercel "PRODUCTION" variables          | `master`                                                |                                                                                                                                                                       |
