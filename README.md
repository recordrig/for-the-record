...
## Branches, environments & variables

| URL / Domain                                                                                               | Env Variables                          | Branch                                                  | Notes                                                                                                                                                                                                                                    |
|------------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| http://localhost:3000                                                                                      | Your local project's root `.env.local` | Any you check out locally using `git checkout <BRANCH>` |                                                                                                                                                                                                                                          |
| Unique domain generated by Vercel. Follows pattern `https://recordrig-site-<RANDOM_STRING>.vercel.app/`.   | Vercel PREVIEW variables             | Any that was pushed to&nbsp;remote&nbsp;(GitHub)                  |                                                                                                                                                                                                                                          |
| https://recordrig-site-git-develop.dcdev1.vercel.app/                                                                                                     | Vercel PREVIEW variables             | `develop`                                               | DEVELOP branch with PREVIEW variables. Can be used to smoke test before merging to MASTER. Only uses test data, so go wild. Can also be used as a generic available test env, e.g. Stripe's Test webhooks might be directed to this URL. |
| https://recordrig-site.now.sh                                                                  | Vercel PRODUCTION variables          | `develop`                                               | DEVELOP branch with PRODUCTION variables. Can be used to smoke test before merging to MASTER - however, **test with caution**, as this _does_ affect PRODUCTION data.                                                                    |
| https://recordrig.com, https://www.recordrig.com (redirects to root domain) | Vercel PRODUCTION variables          | `master`                                                |                                                                                                                                                                                                                                          |                                                                                                                                                                   |
